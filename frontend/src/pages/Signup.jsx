...
export default function Signup() {
    ...
    return (
        <div className="min-h-screen w-full flex bg-white dark:bg-black transition-colors duration-200">
            <SEOHelmet
                title="Sign Up - Join FreelanceCo"
                description="Create your FreelanceCo account to start working as a freelancer or hiring top talent. Join thousands of professionals on our platform."
                keywords="signup, register, join freelanceco, create account, freelance signup"
                noindex={true}
            />
